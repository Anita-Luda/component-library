...
const Atoms = {
    ...
    // --- MEDIA ---
    audio_raw: (p) => `<audio controls class="cmp audio type-${p.type||'default'} is-atom"><source src="#" type="audio/mpeg"></audio>`,
    video_raw: (p) => `<video controls class="cmp video type-${p.type||'default'} is-atom" style="max-width:100%"><source src="#" type="video/mp4"></video>`,
