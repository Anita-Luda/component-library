...
const Templates = {
    dashboard: (p) => {
        ...
        return `
            <div class="cmp template-dashboard is-template">
    ...
    landing_page: (p) => {
        ...
        return `
            <div class="cmp template-landing is-template">
                <header>${nav}</header>
                <main>
    ...
    product_page: (p) => {
        ...
        return `
            <div class="cmp template-product is-template">
                <header>${nav}</header>
    ...
    article_page: (p) => {
        ...
        return `
            <div class="cmp template-article is-template">
                <header>${nav}</header>
    ...
    auth_page: (p) => {
        ...
        return `
            <div class="cmp template-auth is-template">
                <main class="auth-box">
                    ${logo}
                    ${form}
