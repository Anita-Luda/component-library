...
export const Organisms = {
    user_matrix(props) {
        ...
        return `
            <div class="organism-user-matrix cmp">
    ...
    product_grid(props) {
        ...
        return `<div class="organism-product-grid variants-grid">${cards}</div>`;
    },
    ...
    kanban_board(props) {
        ...
        return `<div class="organism-kanban variants-grid">${columns}</div>`;
    },

    chat_window(props) {
        return `
            <div class="organism-chat molecule-card cmp">
